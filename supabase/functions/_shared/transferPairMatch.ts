/**
 * UPARIVANJE DVIJU STRANA PRIJENOSA — Deno zrcalo `src/lib/transferPairMatch.ts`.
 *
 * NE mijenjaj ovu datoteku ručno bez iste izmjene u `src/lib/transferPairMatch.ts`:
 * jezgra između SHARED CORE markera mora biti bajt-identična, što provjerava
 * `src/lib/__tests__/transferPairMatchMirror.test.ts`.
 */
