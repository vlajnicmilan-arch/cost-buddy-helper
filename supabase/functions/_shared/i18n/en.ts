...
export default {
  ...
  "notifications.krug.settlement_receipt_pending.title": "You received a payment",
  "notifications.krug.settlement_receipt_pending.message": "{{name}} paid you {{amount}} {{currency}} — where did it arrive?",
  "notifications.krug.settlement_receipt_pending_anon.title": "You received a payment",
  ...
  "notifications.mail.duplicate.title": "Duplicate received",
  "notifications.mail.duplicate.body": "“{{subject}}” is already in your books and documents — it was not entered twice.",
  "notifications.mail.duplicate.bodyNoSubject": "That mail is already in your books and documents — it was not entered twice.",
  "notifications.mail.staleAlias.title": "Mail sent to your old address",
  "notifications.mail.staleAlias.body": "{{sender}} still sends to your old address {{stale_address}}. Redirect sending to {{current_address}}.",
  "notifications.mail.staleAlias.bodyNoActive": "{{sender}} still sends to your old address {{stale_address}}. Open Documents and enable a new address.",
