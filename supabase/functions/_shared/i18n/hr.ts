...
export default {
  ...
  "notifications.krug.invited.title": "Pozvan si u Krug",
  "notifications.krug.invited.message": "Netko te poziva u svoj Krug. Prihvati ili odbij u aplikaciji.",
  "notifications.krug.invitation_accepted.title": "Pozivnica prihvaćena",
  "notifications.krug.invitation_accepted.message": "Pozvana osoba je prihvatila poziv u Krug.",
  "notifications.krug.invitation_declined.title": "Pozivnica odbijena",
  ...
  "notifications.krug.owner_left.title": "Vlasnik je napustio Krug",
  "notifications.krug.owner_left.message": "Dosadašnji vlasnik je napustio Krug. Vlasništvo je preneseno na drugog punopravnog člana.",
  "notifications.krug.ownership_received.title": "Postao si vlasnik Kruga",
  "notifications.krug.ownership_received.message": "Dosadašnji vlasnik je izašao i prenio vlasništvo na tebe. Sada ti upravljaš ovim Krugom.",
  ...
  "notifications.krug.settlement_receipt_pending.title": "Primio si uplatu",
  "notifications.krug.settlement_receipt_pending.message": "{{name}} ti je platio {{amount}} {{currency}} — gdje je stiglo?",
  "notifications.krug.settlement_receipt_pending_anon.title": "Primio si uplatu",
  ...
  "notifications.krug.override_rejected.message": "Tvoj prijedlog ručne podjele troška je odbijen. Razlog: {{reason}}",
  ...
  "notifications.project_expense_review.approved.title": "Trošak odobren",
  ...
  "notifications.mail.duplicate.title": "Primljen duplikat",
  "notifications.mail.duplicate.body": "„{{subject}}“ je već u knjigama i dokumentima — nije uneseno dvaput.",
  "notifications.mail.duplicate.bodyNoSubject": "Ta pošta je već u knjigama i dokumentima — nije uneseno dvaput.",
  "notifications.mail.staleAlias.title": "Pošta na staru adresu",
  "notifications.mail.staleAlias.body": "Pošiljatelj {{sender}} još šalje na staru adresu {{stale_address}}. Preusmjeri slanje na {{current_address}}.",
  "notifications.mail.staleAlias.bodyNoActive": "Pošiljatelj {{sender}} još šalje na staru adresu {{stale_address}}. Otvori Dokumente i uključi novu adresu.",
