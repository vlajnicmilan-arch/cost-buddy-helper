...
export default {
  ...
  "notifications.krug.invited.title": "Du wurdest in einen Krug eingeladen",
  "notifications.krug.invited.message": "Jemand hat dich in seinen Krug eingeladen. Nimm an oder lehne ab.",
  "notifications.krug.invitation_accepted.title": "Einladung angenommen",
  "notifications.krug.invitation_accepted.message": "Die eingeladene Person hat die Krug-Einladung angenommen.",
  "notifications.krug.invitation_declined.title": "Einladung abgelehnt",
  "notifications.krug.invitation_declined.message": "Die eingeladene Person hat die Krug-Einladung abgelehnt.",
  "notifications.krug.member_left.title": "Ein Mitglied hat den Krug verlassen",
  "notifications.krug.member_left.message": "Ein Mitglied hat diesen Krug verlassen.",
  "notifications.krug.owner_left.title": "Der Eigentümer hat den Krug verlassen",
  "notifications.krug.owner_left.message": "Der bisherige Eigentümer hat den Krug verlassen. Das Eigentum wurde an ein anderes vollwertiges Mitglied übertragen.",
  "notifications.krug.ownership_received.title": "Du bist jetzt Eigentümer des Krug",
  "notifications.krug.ownership_received.message": "Der bisherige Eigentümer hat den Krug verlassen und das Eigentum an dich übertragen. Du verwaltest diesen Krug jetzt.",
  "notifications.krug.membership_notice.title": "Mitgliedschaft im Krug „{{krug}}\"",
  "notifications.krug.membership_notice.message": "Du bist seit {{date}} Mitglied des Krug „{{krug}}\". Wenn du kein Mitglied sein möchtest, kannst du den Krug in den Einstellungen verlassen.",
  "notifications.krug.settlement_reminder.title": "Offene Posten im Krug",
  ...
  "notifications.krug.settlement_receipt_pending.title": "Du hast eine Zahlung erhalten",
  "notifications.krug.settlement_receipt_pending.message": "{{name}} hat dir {{amount}} {{currency}} bezahlt — wo ist es angekommen?",
  "notifications.krug.settlement_receipt_pending_anon.title": "Du hast eine Zahlung erhalten",
  ...
  "notifications.krug.override_rejected.message": "Dein Vorschlag für die manuelle Aufteilung wurde abgelehnt. Grund: {{reason}}",
  ...
  "notifications.project_expense_review.approved.title": "Buchung freigegeben",
  ...
  "notifications.mail.duplicate.title": "Duplikat empfangen",
  "notifications.mail.duplicate.body": "„{{subject}}“ ist bereits in Büchern und Dokumenten — nichts wurde doppelt erfasst.",
  "notifications.mail.duplicate.bodyNoSubject": "Diese E-Mail ist bereits in Büchern und Dokumenten — nichts wurde doppelt erfasst.",
  "notifications.mail.staleAlias.title": "Post an deine alte Adresse",
  "notifications.mail.staleAlias.body": "{{sender}} sendet weiterhin an die alte Adresse {{stale_address}}. Leite den Versand auf {{current_address}} um.",
  "notifications.mail.staleAlias.bodyNoActive": "{{sender}} sendet weiterhin an die alte Adresse {{stale_address}}. Öffne Dokumente und aktiviere eine neue Adresse.",
