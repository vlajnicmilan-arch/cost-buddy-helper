...
BEGIN
  ...
  UPDATE public.project_decisions
     SET current_status = v_next_status,
         ...
         updated_at     = now(),
         -- Faza 4 (vraćeno): novi korak = svježa aktivnost → reset roka i podsjetnika
         overdue        = false,
  ...
  -- Faza 4 (vraćeno): mail sažetak na zatvaranju — fire-and-forget prema notify-decision-closed.
  -- BEGIN/EXCEPTION osigurava da mrežni/HTTP problem NIKAD ne ruši transakciju prihvaćanja.
