...
-- Auto-log activity for projects
...
BEGIN
  ...
  IF v_user_id IS NOT NULL AND v_project_id IS NOT NULL THEN
    INSERT INTO public.project_activity_log (project_id, user_id, action_type, description)
...
CREATE TRIGGER trg_log_milestone_activity
