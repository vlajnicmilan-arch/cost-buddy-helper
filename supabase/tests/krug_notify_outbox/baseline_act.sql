-- Žive definicije (25.09.2026) za: krug_is_member, krug_act_dedup, krug_apply_act.
...
CREATE OR REPLACE FUNCTION public.krug_apply_act(p_expense_id uuid, p_act text, p_client_request_id text, p_reason text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
