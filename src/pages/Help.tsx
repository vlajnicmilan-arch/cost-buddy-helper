...
const FAQ: FaqCategory[] = [
    ...
    entries: [
      {
        ...
        aFallback: 'Klikni gumb „+“ u gornjem desnom kutu. Odaberi vrstu (Prihod, Trošak ili Prijenos), unesi iznos, opis, kategoriju i datum. Kod troška možeš skenirati račun i pustiti da AI popuni polja.',
      },
      {
        ...
        aFallback: 'Izvori plaćanja predstavljaju tvoje stvarne račune (bankovni račun, gotovina, Revolut, kartica…). Otvaraš ih i uređuješ u „Novčaniku“. Saldo svakog izvora ažurira se automatski sa svakom transakcijom.',
      },
      {
        slug: 'categories',
        ...
        aFallback: 'Aplikacija dolazi s ugrađenim kategorijama troškova i prihoda, a možeš dodati i vlastite s ikonom i bojom. Kategorija se predlaže automatski na temelju opisa transakcije.',
      },
    ...
    entries: [
      {
        ...
        aFallback: 'Kod dodavanja troška odaberi „Skeniraj račun“, pa „Fotografiraj“ ili „Iz galerije“. AI čita iznos, trgovinu, datum i stavke; provjeri podatke i klikni „Prihvati i spremi“ — transakcija nastaje iz skena. Na besplatnom planu vrijedi ograničenje od 3 skena u 30 dana.',
      },
      {
        slug: 'scan-accuracy',
        qKey: 'faq.q.scanAccuracy',
        aKey: 'faq.a.scanAccuracy',
        qFallback: 'Što AI očita s računa?',
        aFallback: 'Iznos, trgovinu, datum i pojedinačne stavke, uključujući višestranične račune. Očitano možeš ispraviti prije spremanja — ništa se ne sprema bez tvoje potvrde.',
      },
      {
  ...
  },
  {
    ...
    titleFallback: 'Smjer i projekti',
    icon: Sparkles,
    entries: [
      {
        slug: 'create-budget',
        ...
        qFallback: 'Kako kreirati plan smjera?',
        aFallback: 'Modul planova zove se „Smjer“. Otvori ga i klikni „Novi plan smjera“: postavi naziv, razdoblje (tjedno, mjesečno, godišnje…) i okvir — iznos koji usmjeravaš. Okvir zatim rasporedi po smjerovima. Obavijest stiže kad se približiš okviru.',
      },
      {
        slug: 'share-budget',
        qKey: 'faq.q.shareBudget',
        aKey: 'faq.a.shareBudget',
        qFallback: 'Kako podijeliti plan smjera s drugim korisnikom?',
        aFallback: 'Otvori plan i idi na karticu „Članovi“. Pošalji pozivnicu na email; pozvana osoba dobiva email i obavijest u aplikaciji, a nakon prihvaćanja može pratiti i dodavati transakcije u tom planu.',
      },
      {
        slug: 'project-vs-budget',
        qKey: 'faq.q.projectVsBudget',
        aKey: 'faq.a.projectVsBudget',
        qFallback: 'Razlika između projekta i plana smjera?',
        aFallback: 'Plan smjera je okvir potrošnje za razdoblje, raspoređen po smjerovima. Projekt je samostalna jedinica s vlastitim budžetom, fazama, radnim satima i članovima tima — za renovacije, događaje, honorarne poslove i slično.',
      },
      {
        slug: 'project-pl',
    ...
    entries: [
      {
        ...
        qFallback: 'Kako dijeliti troškove s partnerom ili obitelji?',
        aFallback: 'Kroz Krug. Otvori „Krug“, u kartici „Članovi“ klikni „Pozovi člana“ i unesi email osobe koja već ima račun — članom postaje kad prihvati. U „Zajednički izvori“ povežeš izvor plaćanja, a kod unosa troška biraš „Moje“ ili „Za Krug“. Krug bilježi zajednički trag potrošnje, ne obračunava dugove.',
      },
      {
        slug: 'roles',
        qKey: 'faq.q.roles',
        ...
        aFallback: 'U Krugu: vlasnik, član s pravom odluke (potvrđuje zajedničke troškove) i član bez prava odluke (vidi i dodaje, ali ne odlučuje). U planu smjera: vlasnik, član, gledatelj. Na projektu: vlasnik, član, promatrač, radnik i investitor.',
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        aFallback: 'Postavke → „Podaci i sigurnost“. Dostupni su „Izvezi podatke (JSON)“ i „Izvezi sve podatke (ZIP)“, a izvještaje izvoziš u PDF. Na mobilnoj aplikaciji datoteka se sprema u Preuzimanja.',
      },
      {
        slug: 'import-bank',
        qKey: 'faq.q.importBank',
        aKey: 'faq.a.importBank',
        qFallback: 'Mogu li uvesti bankovni izvod?',
        aFallback: 'Da, iz PDF-a. Otvori „Novčanik“ → „Postavke novčanika“ → „Uvoz transakcija“ → „Uvezi iz PDF-a“. Otvara se „Pregled uvoza“ gdje za svaku stavku biraš „Spoji s postojećim“ ili „Ostavi kao novu“, a na kraju klikneš „Potvrdi uvoz“. Ako ti je uključen „Uvoz iz e-maila“, izvod možeš proslijediti i na svoju adresu za primanje — dokument stiže u „Dokumenti“ → „Na pregled“.',
      },
      {
        slug: 'backup',
        qKey: 'faq.q.backup',
        ...
        aFallback: 'U cloud načinu podaci su automatski sigurnosno kopirani. U lokalnom načinu koristi Postavke → „Podaci i sigurnost“ → „Izvezi podatke (JSON)“ za ručnu kopiju koju kasnije možeš uvesti.',
      },
      {
        slug: 'data-security',
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        aFallback: 'Otvori izvor plaćanja i odaberi „Korigiraj saldo“. Unesi stvarni iznos — sustav kreira korektivnu transakciju koja izjednačava saldo bez diranja povijesti.',
      },
      {
        slug: 'sync-issues',
