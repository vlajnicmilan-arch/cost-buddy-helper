...
const tabs = [
  { id: 'dashboard' as BusinessTab, icon: LayoutDashboard, label: 'Pregled' },
  { id: 'transactions' as BusinessTab, icon: ArrowLeftRight, label: 'Transakcije' },
  { id: 'reports' as BusinessTab, icon: FileBarChart, label: 'Izvještaji' },
  { id: 'more' as BusinessTab, icon: MoreHorizontal, label: 'Više' },
];
