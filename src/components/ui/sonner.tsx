...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      // Ensure the empty toaster container never blocks taps in Android WebView.
      // Individual toasts re-enable pointer-events on themselves.
      style={{ pointerEvents: 'none' } as React.CSSProperties}
      toastOptions={{
        classNames: {
          toast:
            "group toast pointer-events-auto group-[.toaster]:bg-background group-[.toaster]:text-foreground group-[.toaster]:border-border group-[.toaster]:shadow-lg group-[.toaster]:animate-scale-in",
