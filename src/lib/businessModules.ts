...
export const INDUSTRIES: IndustryDefinition[] = [
  {
    ...
    recommended: ['vat_tracking', 'workforce', 'projects', 'travel_expenses', 'kpi_dashboard'],
    optional: ['inventory'],
  ...
  },
  {
    ...
    optional: ['workforce', 'travel_expenses'],
  ...
  },
  {
    ...
    recommended: ['vat_tracking', 'projects', 'travel_expenses', 'kpi_dashboard'],
    optional: ['workforce'],
  ...
  },
  {
    ...
    optional: ['inventory', 'travel_expenses'],
  ...
  },
  {
    ...
    optional: ['vat_tracking', 'workforce', 'projects', 'inventory', 'travel_expenses'],
    categories: [],
  },
];
