/**
 * REGISTAR SKUPINA I KATEGORIJA (dvije razine) + aliasi starih vrijednosti.
 * Zrcalo: supabase/functions/_shared/categoryTree.ts (SHARED CORE mora biti identičan).
 * Još ga ništa ne koristi za prikaz.
 */
// ---------------- SHARED CORE START ----------------
