...
function buildReadme(args: {
  ...
  const lines: string[] = [
    ...
    '',
    'DIJELJENI SADRŽAJ (Krug, tim na projektu, suradnici)',
    '  Izvezeno je ono što je tvoje i ono što ionako vidiš u aplikaciji: tvoja',
    '  članstva i udjeli, prijedlozi koje si ti dao, obračuni u kojima si jedna',
    '  od strana, te tim i suradnici na projektima kojih si vlasnik.',
    '  Osobni podaci drugih ljudi koji nisu dio tvog zapisa (npr. tuđi omjeri',
    '  primanja, tuđe pozivnice, dnevnik članstva) NISU u paketu.',
    '  Pozivnice su izvezene bez tokena — token je ključ, ne podatak.',
    '',
    'PRIVATNOST',
