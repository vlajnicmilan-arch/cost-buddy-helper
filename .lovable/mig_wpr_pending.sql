...
BEGIN
  ...
  -- Samo povezani radnik za SVE isplate u zahtjevu.
  ...
  -- Idempotentnost: isti zahtjev → isti odgovor, bez drugog upisa.
  ...
  -- Već potvrđeno (i stari ručni pripisi): pojedinačno ili kroz zbirnu isplatu.
  IF EXISTS (
